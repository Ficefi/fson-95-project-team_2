import{s as b,a as y,b as S,c as w,d as m,e as k}from"./assets/fetchAPI-eb580cdb.js";import{P}from"./assets/vendor-b592f4c5.js";const r=document.querySelector(".footer-form-authorization");r.addEventListener("submit",$);function $(e){e.preventDefault(),b(r[0].value),r.reset()}const g=document.querySelector(".card"),M=2;function C(e,t,s=0){const a=s+M;return e.slice(s,a).map(({img:n,price:o,_id:u,desc:v},f)=>`<li class="card_item" data-id="${u}">
    ...
    </li>`).join("")}async function L(){const e=await y();console.log(e);const t=e.reduce((a,c)=>(c.name.length>10?a.push(c.name.slice(0,10)+"..."):a.push(c.name),a),[]);g.innerHTML=C(e,t),g.addEventListener("click",a=>{const c=a.target.closest(".card_item");if(c){const i=c.dataset.id;S(i)}});const s=document.querySelectorAll(".basket");console.log(s),s.forEach(a=>{a.addEventListener("click",E);const c=a.dataset.id;T(c)&&(a.setAttribute("disabled",!0),a.innerHTML=`
        <svg class="basket-icon-check" width="18" height="18">
          <use href="../img/icons.svg#icon-check"></use>
        </svg>
      `)})}L();function E(e){const t=e.currentTarget;console.log(t);const s=t.dataset.id;console.log(s),t.hasAttribute("disabled")?(h(s),console.log(h(s)),t.removeAttribute("disabled"),t.innerHTML=`
      <svg class="basket-icon" width="18" height="18">
        <use href="../img/icons.svg#icon-cart"></use>
      </svg>
